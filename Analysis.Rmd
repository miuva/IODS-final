# Abstract
*School is the place were adolescent spend great part of their week. I wanted to see whether lower support provided by teachers and parents, lower felt justice and lower feel of ones own worth and appreciation is connected to daily or weekly mental problems including tension and nervousness, irritability or outbursts of anger, problems with falling asleep or waking up at night time, tiredness or weakness, depression and fear.*    
    
*I used Anne Konu´s survey data which is part of the School Well-being Profile -project. I chose  21 independent variables (gender + 20 Likert-scale questions) and 6 dependent variables (symptoms and illnesses). I used logistic regression to find the best model for each dependent variable.*        
    
*Only gender had a clear impact on the models created. Other questions had mostly only minor impact on the models. The most important questions were whether or not parent´s help adolescent with they homework, adolescent feel that they have meaning in school and feeling oneself appreciated but also their impact on the models were quite small. The predictive power of the models was also very low when trying to find adolescents who have mental symptoms daily or weekly.*

# Research question
My aim is to explore if there is a connection between how well adolescents at grades 7-9 in lower secondary school get support from their teachers and families and how often they have mental symptoms. My hypothesis is that adolescents who get less support from their teachers and families, who don´t feel appreciated, who find their school´s rules unfair and unreasonable have more often (daily or weekly) mental symptoms which in this data are tension or nervousness, irritability or outbursts of anger, problems with falling asleep or waking up at night time, tiredness or weakness, depression or fear.  

# The data
The survey data I will use is part of Anne Konu´s (University of Tampere) School Well-being Profile -project which is collected in years 2015-2016. The sample is not random because schools have took part to the project by their own accord if they have wanted to investigate their well-being profile. More information about the project you can find [here](http://www10.edu.fi/hyvinvointiprofiili/info.php?lang=) (only in Finnish or Swedish) and [here](https://services.fsd.uta.fi/catalogue/FSD3117?lang=en&study_language=en). The data is provided by The Finnish Social Science Data Archive.    
...
g19 + geom_bar(width = .6, position = "dodge") + labs(x = "", y = "Count", title ="Q11_19", subtitle = "The teachers encourage me with studying",  caption = "Figure 19: Also here the positive answers are the most common ones. \n Here the boys seem to feel slightly more encouraged than girls.", fill = "Gender") + theme(plot.caption = element_text(hjust = 0.5))
...
As we can see from the plots above most of the pupils feel that they are appreciated and supported by their teachers and parents. But in every question there is a small minority of pupils who don´t agree with these statements.    
...
As we have seen earlier it is quite hard to predict mental symptoms which occur daily or weekly with questions about relationships with teachers and parents and the support they will provide. There are some variables which have more connection to these symptoms than others. The most important one is gender. It seems that overall boys have less or more rarely mental symptoms daily or weekly than girls.  
    
For tension and nervousness Likert-scale questions q11_2 = "At school I´m regarded as a person who has a meaning." and q10_3 "My parents help me with my homework if necessary." were the most important. For irritability or outbursts of anger the same questions as for tension and nervousness and also the question q7_10 "It is easy to get along with the teachers." were the most important. For sleep problems and also for tiredness and weakness the most important questions were q10_1 "My parents appreciate my schoolwork." and q10_3 "My parents help me with my homework if necessary." With depression the question q11_2 "At school I´m regarded as a person who has a meaning." had the greatest connection and also questions q10_1 "My parents appreciate my schoolwork."and q7_9 "The teachers treat us with justice." had small impact on the model. Feeling fear was most connected to question q11_2 "At school I´m regarded as a person who has a meaning." and also to question q11_1 "My work is appreciated at school." So the parents quite practical support, the feeling of having meaning in school and feeling oneself appreciated seem to be the most meaningfulfactors in respect of better mental health. It´s good to note that the relationship is two-way. For example in depression feeling having no meaning can be a symptom itself and work as a vicious circle.
    
All in all if we look at these results we can see that only few of the questions have some relationship with the symptoms but these relationships aren´t very big (except gender). By themselves they cannot form a model which could predict mental symptoms which occur daily or weekly well enough. 

There are also some weaknesses in my analysis. I changed all the scales except gender to numeric. I could have used ordinal regression which seems to be the recommended option for Likert-scale questions. I also could have paid more attention to the missing values and see if there is some clear pattern between them. And if necessary I could have used imputation to fill those gaps. Hopefully for the next analysis I have more skills to make it in a better way.

If we think the original purpose of this data and the project behind it we can notice that it´s purpose is to find out how the pupils see their school, their teachers and support they get and if they have some symptoms or illnesses which can influence the school days.  So although the models created here weren´t so suitable the project itself provides a good tool to evaluate the quality of school and notice if there is something which needs improvement or special attention. Even though most of the pupils feel well in the school and home there are also those who feel the opposite and these adolescents need special attention and help to get as good as possible tools and support for life.

# References
Konu, Anne (University of Tampere): School´s Well Being Profile 2015-2016: Lower secondary school, grades 7-9 [electronic archive]. Version 1.0 (2016-07-18). The Finnish Social Science Data Archive [distributor]. http://urn.fi/urn:nbn:fi:fsd:T-FSD3117
